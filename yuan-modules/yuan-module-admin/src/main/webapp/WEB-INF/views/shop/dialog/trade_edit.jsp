					...
					<tr>
                     ...
                     <tr>
						<td class="l_title w150"><b class="cRed">*</b>订单状态</td>
                         <td>
                             <div class="J_toolsBar fl">
								     <label><input name="status" type="radio" value=1 <c:if test="${bean.status == null || bean.status == 1 }">checked="checked"</c:if> />待发货</label> 
									 <label><input name="status" type="radio" value=2 <c:if test="${bean.status == 2 }">checked="checked"</c:if>/>已发货</label> 
