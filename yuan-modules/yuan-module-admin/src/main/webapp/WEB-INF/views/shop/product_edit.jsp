		...
		<div id="addForm" class="mgt20">
			<form action="${ctx }/shopproduct/save" id="editForm" method="post">
				<input type="hidden" name="id" value="${bean.id }" /> <input
					...
					value="${bean.proLogoImg }" /> <input type="hidden" name="picture1"
					id="picture1" value="${bean.picture1 }" /> <input type="hidden"
					name="picture2" id="picture2" value="${bean.picture2 }" /> <input
					type="hidden" name="picture3" id="picture3"
					value="${bean.picture3 }" /> <input type="hidden" name="picture4"
					id="picture4" value="${bean.picture4 }" /> <input type="hidden"
					name="picture5" id="picture5" value="${bean.picture5 }" />
				<div class="">
									...
									<div class="J_toolsBar fl">
										<div class="t_text w200 ml10">
											<label> <c:choose>
													...
													<c:otherwise>
														<select name="type" id="type" data-rule="商品类型:required;" onchange="changeType()">
				...
				.uploadify(
						{
							...
							'onUploadSuccess' : function(file, data, response) {
								if (data != null) {
									...
									$("#pic" + num).attr('src', attachUrl);
									$("#picture" + num).val(data);
								}
							}
						});
	</script>
