...
jc.uiExtend("footer", {
    template: function (data) {
        ...
        html += '<h4>关于 顶呱呱工作室</h4>';
        html += '<p class="mt20"><i class="icon"></i>地址：江西省赣州市沙石镇楼梯领88号</p>'
        html += '<p><i class="icon"></i>邮箱：dingjinqing@163com</p>'
        html += '</div>';
        ...
        html += '<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=273371187&site=qq&menu=yes">';
        html += '<img style="width:120px;" src="../../static/images/weixinzan.png">';
        html += '</a>';
        html += '<p>(微信赞赏)</p>';
        html += '</div>';
        html += '</div>';
        ...
        html += '<div class="mt20 text-center">';
        html += '<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=273371187&site=qq&menu=yes">';
        html += '<img style="width:120px;" src="../../static/images/haoyou.jpg">';
        html += '</a>';
        html += '<p>(添加好友)</p>';
        html += '</div>';
        html += '</div>';
        ...
        html += '<span>© 2018-2023</span>';
        html += '版权所有 yuan CMS Copyright © 2018 - 2023 Tencent. All Rights Reserved';
        html += '<span>赣ICP备18012025号-1</span>';
        html += '</div>';
        html += '</div>';
